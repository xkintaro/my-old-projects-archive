...
AutoEventWireup="true" CodeFile="giris.aspx.cs"
Inherits="assets_pages_userPages_giris" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
  <title>TEKNOFİLM - GİRİŞ</title>
  <style>
    .movies-grid {
      display: block;
    }
        ...
        <div class="hakkimda">
          ...
          <div class="hakkimda-content">
            ...
            <div class="kayit-ol">
              ...
              <div class="kyt-cont">
                <a href="kayit.aspx" class="btn-kayit">KAYIT OL</a>
              </div>
            </div>
          </div>
        </div>
